...
class SwitchToggleJD extends CWidget {
    ...
    /* Visible para mostrar la etiqueta o el SwichtToggle */
    public $visible = true;
    ...
    private function LabelSimple() {

        if ($this->model[$this->attribute] == 1) {
            $class = 'label-activo';
            $text = 'Activo';
        } elseif ($this->model[$this->attribute] == 0) {
            $class = 'label-inactivo';
            $text = 'Inactivo';
        } elseif ($this->model[$this->attribute] == 2) {
            $class = 'label-eliminado';
            $text = 'Eliminado';
        } else {
            $class = 'label-otro';
        ...
        $data = '<span class="labelswicht ' . $class . ' ">';
        $data.= $text;
        $data .= '</span>';
