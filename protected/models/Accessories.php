 ...
 * @property AccessorieWarranties[] $accessorieWarranties
...
class Accessories extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'accessorieWarranties' => array(self::HAS_MANY, 'AccessorieWarranties', 'accessorie_id'),			
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'name' => 'Seleccione los accesorios del equipo',
			'active' => 'Active',
		);
	}
