...
class Distributors extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, name, address, phone_local, phone_personal, email, representative, country_id, record_fiscal, category_id', 'required'),
			array('user_id, country_id, state_id, category_id, city_id, active', 'numerical', 'integerOnly'=>true),
			array('name, phone_local, phone_personal, email, representative, record_fiscal', 'length', 'max'=>45),
			...
			array('id, user_id, name, address, phone_local, phone_personal, email, representative, country_id, state_id, record_fiscal, category_id, active, created, modified', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
		'devices' => array(self::HAS_MANY, 'Devices', 'distributor_id'),
                'user' => array(self::BELONGS_TO, 'Users', 'user_id'),
                'country' => array(self::BELONGS_TO, 'Countries', 'country_id'),
                'state' => array(self::BELONGS_TO, 'States', 'state_id'),
                'city' => array(self::BELONGS_TO, 'Cities', 'city_id'),
                'category' => array(self::BELONGS_TO, 'Categories', 'category_id'),
                'users' => array(self::HAS_MANY, 'Users', 'distributor_id'),
		);
	}
