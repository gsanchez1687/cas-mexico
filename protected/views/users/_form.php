...
<div class="form">
	...
	<div>
		...
		<?php echo $form->textField($model,'username',array('size'=>15,'maxlength'=>15,'class'=>'input-alfanumerico')); ?>
		<?php echo $form->error($model,'username'); ?>
	</div>
	
	<div>
		<?php echo $form->labelEx($model,'password'); ?>
		<?php echo $form->textField($model,'password',array('size'=>15,'maxlength'=>15,'class'=>'input-alfanumerico')); ?>
	...
	<div>
		...
		<?php echo $form->textField($model,'lastname',array('size'=>50,'maxlength'=>50,'class'=>'input-alfanumerico-space')); ?>
	...
	<div>
		...
		<?php echo $form->textField($model,'phone_local',array('size'=>20,'maxlength'=>20,'class'=>'input-integer')); ?>
		<?php echo $form->error($model,'phone_local'); ?>
	</div>

	<div>
		<?php echo $form->labelEx($model,'phone_personal'); ?>
		<?php echo $form->textField($model,'phone_personal',array('size'=>20,'maxlength'=>20,'class'=>'input-integer')); ?>
		<?php echo $form->error($model,'phone_personal'); ?>
	</div>

	<div>
		<?php echo $form->labelEx($model,'rol_id'); ?>		
                <?php echo $form->dropDownList($model,'rol_id',CHtml::listData(Roles::model()->findAll(array('order' => 'id ASC')), 'id', 'name'), array('empty'=>'Seleccione')); ?>
		<?php echo $form->error($model,'rol_id'); ?>
	</div>

	<div>
		<?php echo $form->labelEx($model,'address'); ?>
		<?php echo $form->textArea($model,'address',array('maxlength'=>200,'rows'=>6, 'cols'=>50,'class'=>'input-alfanumerico-space')); ?>
