<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <?php echo CHtml::link('Lista de usuarios', array('users/mytechnician'), array('class' => 'btn btn-primary btn-3d')); ?>
        <?php echo CHtml::link('Actualizar datos', array('users/updatetechnician/'.$model->id), array('class' => 'btn btn-primary btn-3d')); ?>
    </div>
</div>