    ...
    public function accessRules() {
        return array(
            array('allow', // allow all users to perform 'index' and 'view' actions
                'actions' => array('index', 'view', 'rolesitems', 'usersitems','user'),
                'users' => array('@'),
            ),
...
//        foreach ($data as $d){
//            
//         $roles = RolesItems::model()->findAll("rol_id = '$d->rol_id'");   
//            
//         
//         foreach ($roles as $r){             
//             $permiso = new UsersRolesItems();
//             $permiso->user_id = $d->id;
//             $permiso->rol_item_id = $r->id;
//             $permiso->active = 1;
//             $permiso->save();
//             print_r($permiso->getErrors());
//             
//             
//         }
//            
...
//        }
    ...
    public function actionRolesitems() {
        ...
        $this->render('rolesitems', array('model' => $model,'options' => $options));
                      ...
                      $log->description = "Usuario ha tratado de accesar a un lugar restringido<br/>Modulo: <b>Maquinas</b>Accion:<b>Vista</b>.";
