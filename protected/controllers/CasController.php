...
class CasController extends Controller
{
	...
	{
            if(Yii::app()->authRBAC->checkAccess('cas_add')){
		...
		if(isset($_POST['Cas']))
		{
			$model->attributes=$_POST['Cas'];                                              
                        ...
                        if($model->save()){       
                                ...
                                if($this->enviar($model->name,$contraseñaAleatoria,$model->email)){
                                      Yii::app()->user->setFlash('success_email', "El correo ha sido enviado con exito al destinatario");
                                }                              
	...
	{
            if(Yii::app()->authRBAC->checkAccess('cas_edit')){
                $User = new Users;      
		$model=$this->loadModel($id);
	...
	{
            if(Yii::app()->authRBAC->checkAccess('cas_delete')){
	...
	{
		$dataProvider=new CActiveDataProvider('Cas');
	...
	{
            if(Yii::app()->authRBAC->checkAccess('cas_admin')){
		$model=new Cas('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Cas']))
			$model->attributes=$_GET['Cas'];
	 ...
	 * @return Cas the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Cas::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Cas $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cas-form')
		{
        ...
        $mailer->Body = '     
                                ...
                                <body>
                                    <div class="container" id="page">
                                        ...
                                        <div id="content">
                                            <p><b>Centro Autorizado de Servicio  le da la bienvenida</b></p>
